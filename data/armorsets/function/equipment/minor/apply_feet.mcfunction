...
summon armor_stand ~ ~ ~ {NoAI:1b,Tags:["armorsets.armor_stand.temp"],equipment:{mainhand:{id:"minecraft:leather_boots",count:1b}}}
...
execute if data storage armorsets:data item{unbreakable:0b} run item modify entity @s armor.feet armorsets:hide_enchantment_info
